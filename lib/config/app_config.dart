class AppConfig {
  static const String mqttHost = '192....'; // <-- IP/host del broker
  ...
  // - Celular físico: IP de tu PC (ej: 192...)

  //static const String backendHost = ''; // <--- CAMBIAR ESTO POR LA IP DEL SERVIDOR
